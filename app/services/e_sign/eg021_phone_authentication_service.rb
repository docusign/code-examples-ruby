...
class ESign::Eg021PhoneAuthenticationService
  include ApiCreator
  ...
  def call
    ...
    signer1.id_check_configuration_name = 'Phone Auth $'

    phoneAuth = DocuSign_eSign::RecipientPhoneAuthentication.new
    phoneAuth.record_voice_print = 'false'
    phoneAuth.validate_recip_provided_number = 'false'
    phoneAuth.recip_may_provide_number = 'true'

    phoneAuth.sender_provided_numbers = [request.params[:phoneNumber]]
    signer1.phone_authentication = phoneAuth
