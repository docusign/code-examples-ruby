...
class ESign::Eg020SmsAuthenticationService
  include ApiCreator
  ...
  def call
    ...
    signer1.id_check_configuration_name = 'SMS Auth $'

    sms = DocuSign_eSign::RecipientSMSAuthentication.new
    sms.sender_provided_numbers = [request.params[:phoneNumber]]
    signer1.sms_authentication = sms
